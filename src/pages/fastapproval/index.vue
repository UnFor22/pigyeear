<template>
  <div class="wrapper">
    <img class="bgImg" src="http://ioskamidownload.oss-cn-qingdao.aliyuncs.com/shenpikuai%402x_02.ae3f587.png" alt="" onclick="return false" mode="widthFix"> 
      ...
      <!-- <mt-loadmore :bottom-method="loadBottom" :bottom-all-loaded="bottomAllLoaded" :auto-fill="false" ref="loadmore" :bottomPullText='bottomText' :bottomDropText="bottomDropText"> -->
        <div class="box">
          ...
          <div class="firstCard">
            ...
            <div class="button" @click="tokefu(firstData.creditname,firstData.crediturl)"><a style="color: #fff; font-size: 15px">
              立即申请</a></div>
          </div>
    ...
    data () {
      return {
        ...
        filterSearch: {
          ...
          type: 3,		//{label: '大额度', value: 1},{label: '新手办卡', value: 2},{label: '审批快', value: 3},{label: '办卡有礼', value: 4},
