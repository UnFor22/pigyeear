...
<script>
  ...
  import {getHotBankInfoList, getTopicSelect, getBannerImg, getHotCard, getBannerTxt,registerHref,userOperation,getUserOpenid,postUser} from '../../requestAPI/requestAPI';
  export default {
    data(){
      return {
        isLogin: true,
